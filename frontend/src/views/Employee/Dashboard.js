      ...
      <Row>
        ...
        <Col lg="3" md="6" sm="6">
          <Card className="card-stats">
            ...
            <CardFooter>
              <Button tag={Link} to="/employee/reports" className="btn-fill" color="success">
                More
              </Button>
            </CardFooter>
          </Card>
        ...
        <Col lg="3" md="6" sm="6">
          <Card className="card-stats">
            ...
            <CardFooter>
              <Button tag={Link} to="/employee/disaster" className="btn-fill" color="danger">
                More
              </Button>
            </CardFooter>
          </Card>
        ...
        <Col lg="3" md="6" sm="6">
          <Card className="card-stats">
            ...
            <CardFooter>
              <Button tag={Link} to="/employee/area" className="btn-fill" color="info">
                More
              </Button>
            </CardFooter>
          </Card>
